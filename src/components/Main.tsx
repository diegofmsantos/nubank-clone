...
export const Main = () => {
    ...
    return (
        <main className="">
            ...
            <section className="w-screen h-screen md:h-screen bg-[url('src/assets/banner-1.png')] bg-no-repeat bg-cover bg-bottom flex">
            ...
            <section className="w-full h-full bg-[url('src/assets/banner-6.png')] bg-no-repeat bg-cover bg-left-bottom flex justify-center items-start md:w-screen md:justify-start lg:h-screen">
            ...
            <section className="w-full h-full bg-[url('src/assets/banner-7.png')] bg-no-repeat bg-cover bg-left-bottom flex justify-center items-start md:w-screen md:justify-start lg:h-screen">
